 ...
 */
public class CustomFilesAdapterDocuments extends BaseAdapter implements View.OnClickListener {
    ...
    public CustomFilesAdapterDocuments(Activity a, ArrayList<TaskFile> d, Resources resLocal, String val) {
