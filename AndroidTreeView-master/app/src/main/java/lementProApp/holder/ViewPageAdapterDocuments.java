 ...
 */
public class ViewPageAdapterDocuments extends FragmentStatePagerAdapter {
    ...
    public ViewPageAdapterDocuments(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                return new DescriptionTabFragmentDocument();
            case 1:
                return new DiscussionsTabFragmentDocument();
            case 2:
