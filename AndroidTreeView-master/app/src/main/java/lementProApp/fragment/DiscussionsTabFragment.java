...
public class DiscussionsTabFragment extends Fragment {
	String objectID = "";
	View rootView;
	...
	CustomDiscussionAdapter adapter;
	public DiscussionsTabFragment CustomListView = null;
	String replyMessage = "";
		...
		try {
			...
			imgSend.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					(new AsyncMessageSender()).execute(getString(R.string.Link) + "Services/Tasks/Action/Create.do");
			...
			try {
				...
				arrList.clear();
				adapter = new CustomDiscussionAdapter(CustomListView, arrList, res, cookieVal);
			...
			(new AsyncDiscussionLoader()).execute(getString(R.string.Link) + "Services/Tasks/Action/GetList.do?objectId=" + objectID);
		} catch (Exception e) {
			e.printStackTrace();
		}
