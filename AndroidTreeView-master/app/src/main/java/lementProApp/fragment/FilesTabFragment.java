...
public class FilesTabFragment extends Fragment {
    ...
    public FilesTabFragment CustomListView = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            try {
                ...
                arrList.clear();
                adapter = new CustomFilesAdapter(CustomListView.getActivity(), arrList, res, cookieVal);
            ...
            (new AsyncTaskFileLoader()).execute(getString(R.string.Link) + "Services/Tasks/File/GetList.do?id=" + objectID);
        } catch (Exception e) {
            e.printStackTrace();
        }
