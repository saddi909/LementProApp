...
public class TasksList extends ActionBarActivity {
    ...
    public TasksList CustomListView = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cookieVal == null || cookieVal.equals("")){
            ...
            editor.clear();
            editor.commit();
            Intent i = new Intent(TasksList.this, Login.class);
            TasksList.this.startActivity(i);
        }
    ...
    public void onItemClick(int mPosition,String Id,String folderKey)
    {
        if(type.equals("1")) {
            Intent i = new Intent(TasksList.this, TaskDetails.class);
            i.putExtra("objectID", Id);
            TasksList.this.startActivity(i);
        }else if(type.equals("2")){
            Intent i = new Intent(TasksList.this, DocumentDetails.class);
            i.putExtra("objectID", Id);
            i.putExtra("folderKey",folderKey);
            TasksList.this.startActivity(i);
        }else if(type.equals("3")) {
            Intent i = new Intent(TasksList.this, ProjectDetails.class);
            i.putExtra("objectID", Id);
            TasksList.this.startActivity(i);
         }
    }
