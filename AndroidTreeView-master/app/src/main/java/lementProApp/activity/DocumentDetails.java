...
import lementProApp.holder.ViewPageAdapterDocuments;
...
public class DocumentDetails extends ActionBarActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPageAdapterDocuments adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Description","Discussions","Approving","Files"};
    int Numboftabs =4;
    String objectID = "";
    String folderKey = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPageAdapterDocuments(getSupportFragmentManager(),Titles,Numboftabs);

        // Assigning ViewPager View and setting the adapter
        pager = (ViewPager) findViewById(R.id.pagerNew);
        pager.setTag(R.string.FirstTag,objectID);
        pager.setTag(R.string.SecondTag,folderKey);
