 ...
 */
public class ProjectFolders extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(cookieVal == null || cookieVal.equals("")){
            ...
            editor.clear();
            editor.commit();
            Intent i = new Intent(ProjectFolders.this, Login.class);
            ProjectFolders.this.startActivity(i);
        }
        ...
        (new AsyncListViewLoader()).execute(getString(R.string.Link) + "Services/Projects/Folder/GetTree.do");
    ...
    private TreeNode.TreeNodeLongClickListener nodeLongClickListener = new TreeNode.TreeNodeLongClickListener() {
        ...
        public void onClick(TreeNode node, Object value) {
            ...
            Intent i = new Intent(ProjectFolders.this, TasksList.class);
            i.putExtra("link", getString(R.string.Link) + "Services/Project/GetList.do");
