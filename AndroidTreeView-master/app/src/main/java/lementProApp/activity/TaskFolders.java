 ...
 */
public class TaskFolders extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(cookieVal == null || cookieVal.equals("")){
            ...
            editor.clear();
            editor.commit();
            Intent i = new Intent(TaskFolders.this, Login.class);
            TaskFolders.this.startActivity(i);
        }
        ...
        (new AsyncListViewLoader()).execute(getString(R.string.Link)+ "Services/Tasks/Folder/GetTree.do");
    ...
    private TreeNode.TreeNodeLongClickListener nodeLongClickListener = new TreeNode.TreeNodeLongClickListener() {
        ...
        public void onClick(TreeNode node, Object value) {
            ...
            Intent i = new Intent(TaskFolders.this, TasksList.class);
            i.putExtra("link", getString(R.string.Link) + "Services/Task/GetList.do");
