...
import lementProApp.holder.ViewPageAdapterProject;
...
public class ProjectDetails extends ActionBarActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPageAdapterProject adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Description","Documents"};
    int Numboftabs =2;
    String objectID = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPageAdapterProject(getSupportFragmentManager(),Titles,Numboftabs);
