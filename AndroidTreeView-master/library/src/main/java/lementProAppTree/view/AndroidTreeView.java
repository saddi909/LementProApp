...
import lementProAppTree.R;
import lementProAppTree.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    private void addNode(ViewGroup container, final TreeNode n) {
        ...
        nodeView.setLongClickable(true);
        ...
        nodeView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (n.getLongClickListener() != null) {
                    n.getLongClickListener().onClick(n, n.getValue());
                } else if (nodeLongClickListener != null) {
                    nodeLongClickListener.onClick(n, n.getValue());
                }
                //toggleNode(n);
                return true;
            }
